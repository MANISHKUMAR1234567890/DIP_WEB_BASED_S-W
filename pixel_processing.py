...
with subtab[1]:
    ...
    st.image(bright_image,caption="Brighten image",use_container_width=False)
    st.code("""
            import numpy as np
            import cv2
            from PIL import Image
...
with subtab[2]:
    ...
    st.image(contrast_stretched,caption="Contrast Stretched",use_container_width=False)
    st.code("""
             import numpy as np
            import cv2
            from PIL import Image
...
with subtab[3]:
    ...
    st.image(equalized_image,caption="Histogram equilized image",use_container_width=False)
    st.code("""
            import numpy as np
            import cv2
            from PIL import Image
